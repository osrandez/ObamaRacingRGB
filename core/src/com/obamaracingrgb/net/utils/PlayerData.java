...
public class PlayerData {
    ...
    public byte[] serialize() {
        String line = (index + "|" +
                pos.x + "/" + pos.y + "/" + pos.z + "|" +
                linearSpd.x + "/" + linearSpd.y + "/" + linearSpd.z+"|"+"fin");
        System.out.println("Serializando: "+line);
    ...
    public static PlayerData deserialize(byte[] n) {
        ...
        line=line.substring(0, line.indexOf("fin"));
        System.out.println("Deserializando: "+line);
